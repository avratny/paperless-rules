            ...
            <div class="bg-gradient-to-br from-gray-900/50 to-gray-800/50 backdrop-blur-sm rounded-2xl border border-gray-800/50 shadow-xl overflow-hidden">
                <div class="p-8">
                    ...
                    <div class="flex items-center mb-6">
                        <div class="w-10 h-10 bg-gradient-to-br from-purple-500 to-pink-600 rounded-lg flex items-center justify-center mr-3 p-2">
                        ...
                        <div>
                            <h3 class="text-xl font-semibold text-white">{{ __('AI Model Settings') }}</h3>
                            <p class="text-sm text-gray-400 mt-1">{{ __('Configure the connection to your Ollama instance') }}</p>
                        </div>
                    </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <x-forms.text-input
                            ...
                            hint="{{ __('The URL of your Ollama instance (default: http://localhost:11434)') }}"
                        />
